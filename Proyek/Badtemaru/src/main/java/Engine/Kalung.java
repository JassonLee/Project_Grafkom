...
public class Kalung extends Object{
    private List<float[]> PointControl = new ArrayList<>();
    public Kalung(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<float[]> PointControl) {
