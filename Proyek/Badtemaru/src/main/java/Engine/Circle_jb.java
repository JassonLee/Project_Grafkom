...
public class Circle_jb extends Object {

    Float radiusX;
    Float radiusY;
    public Circle_jb(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint, Float radiusX,Float radiusY) {
