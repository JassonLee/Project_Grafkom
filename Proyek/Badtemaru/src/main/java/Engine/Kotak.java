...
public class Kotak extends Circle_jb{
    float radiusZ;
    int stackCount;
    int sectorCount;
    public Kotak(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint, Float radiusX, Float radiusY, Float radiusZ,
